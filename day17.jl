...
@testset "initspace" begin
    ...
    @test size(s) == (5,5,3)
    @test s[2:4,2:4,2] == [0 1 0; 0 0 1; 1 1 1]
end
...
@testset "update" begin
    s = initspace(IOBuffer(testinput),1)
    s = update(s)
    @test s[3:5, 2:4, 1] == [1 0 0; 0 0 1; 0 1 0]
    @test s[3:5, 2:4, 2] == [1 0 1; 0 1 1; 0 1 0]
    @test s[3:5, 2:4, 3] == [1 0 0; 0 0 1; 0 1 0]
